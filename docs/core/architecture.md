...
- **Login**: `/api/auth/login` with email/password. Identifier, Vercel-derived client, and global database budgets bound guessing and roster-wide spraying across instances.
