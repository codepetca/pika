...
| API request/query contracts or external input validation | [`docs/guidance/api-boundary-validation.md`](./guidance/api-boundary-validation.md) |
...
- API boundaries: parse untrusted input once with a feature-owned Zod schema; do not expand the validation-debt baseline
