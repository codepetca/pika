...
### 1. Should dense data tables remain workflow-specific?
...
### 2. How reusable is the student assignment summary card?
...
### 3. When should details live in a right sidebar versus inline content?
...
### 4. Which save-state language should become standard?
