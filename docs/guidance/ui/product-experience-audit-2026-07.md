...
- Hydration-safe readiness detection prevents a completed same-origin iframe from remaining behind its loading state. A bounded timeout distinguishes a stalled embed and exposes Retry without presenting the failed document as empty.
