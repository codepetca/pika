...
| Hot archive discovery/actions | Committed pair plus focused CI-backed browser matrix | Safety Wave captures Delete removal. Phase 5 now covers recovery-copy unavailable, available, confirmation, verified, and student-absence states at desktop/mobile in both themes. Compaction and cold-restore progress remain. |
