...
| Blueprints | Desktop committed; actions/create local-only; seeded rollover and publication lifecycle drills are CI-backed | Phase 5 retains browser coverage for classroom round trips and planned-site publish/unpublish behavior; broader preview/version workflow evidence remains. |
