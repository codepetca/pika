...
hosted migration 129, cross-service, latency, and canary proof remains intentionally
open.
...
1. Review migration 129 and this canary implementation, then open a Pika PR.
