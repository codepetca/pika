...
The current recovery sequence requires migrations 142 and 144 together.
Migration 142 adds the service-role-only, fully audited obsolete-epoch recovery;
migration 144 makes the resulting epoch change advance both roster and schedule
