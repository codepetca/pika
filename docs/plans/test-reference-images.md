...
Date: 2026-09-24
Status: PR #1355 implementation and local verification complete. Final cumulative review found an archive-restore interaction; archive recovery correction and independent checker are verified locally and await targeted closure review, then ready CI.
