...
describe('StudentLayout', () => {
  ...
  it('uses the canonical app shell and preserves the existing student utility destinations', async () => {
    ...
    expect(screen.getByRole('link', { name: 'Attendance' })).toHaveAttribute('href', '/student/history')
    expect(screen.getByRole('link', { name: 'Attendance' })).toHaveAttribute('aria-current', 'page')
