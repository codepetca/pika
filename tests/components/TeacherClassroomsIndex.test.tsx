...
describe('TeacherClassroomsIndex', () => {
  ...
  it('opens a newly created classroom with the class-day review reminder and getting-started chain', () => {
    renderTeacherClassroomsIndex([])
    ...
    expect(push).toHaveBeenCalledWith(
      '/classrooms/new-classroom?tab=daily&onboarding=start&reviewClassDays=1',
    )
  })
