...
const migration = readFileSync(
  resolve(process.cwd(), 'supabase/migrations/155_discard_pristine_assessment_drafts.sql'),
  'utf8',
).toLowerCase()
...
describe('pristine assessment draft discard migration', () => {
  ...
  it('uses the Test writer lock order and rejects a concurrent draft version', () => {
