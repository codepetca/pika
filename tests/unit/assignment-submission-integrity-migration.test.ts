...
describe('assignment submission integrity migration', () => {
  ...
  it('proves the migration-first compatibility and CI rollout contract', () => {
    ...
    expect(restoreSource).toContain("'134_blueprint_test_question_ordinal_identity' as const")
    expect(restoreSource).toContain("id: 'classroom-archive-schema-082-to-134'")
  })
})
