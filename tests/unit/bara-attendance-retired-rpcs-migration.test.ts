...
describe('retired unscoped Bara attendance RPC migration', () => {
  ...
  it('keeps active rollout guidance aligned with the production migration state', () => {
    ...
    expect(v1Guide).toContain('no legacy `attendance.marks` or status-event compatibility path')
    ...
    expect(currentContext).toContain('Prod DB 001–151 verified 2026-09-02; lint 0.')
