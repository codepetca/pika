...
const paidSnapshot = {
  ...
  scheduleId: null,
  items: [{
    productId: binding.stripe_product_id, priceId: binding.stripe_price_id, unitAmount: binding.unit_amount,
  ...
  latestInvoice: {
    ...
    billingReason: 'subscription_cycle', subtotal: 2000, total: 2000, startingBalance: 0,
    endingBalance: 0, totalDiscountAmount: 0, totalTaxAmount: 0, hasDiscounts: false, hasTaxes: false,
    prePaymentCreditNotesAmount: 0, postPaymentCreditNotesAmount: 0,
    currency: 'usd',
    ...
    lines: [{
      ...
      hasDiscounts: false, hasTaxes: false,
