...
describe('PageMockups', () => {
  ...
  it('renders the production-shaped Daily controls with deterministic attendance interactions', async () => {
    ...
    const openQr = within(daily).getByRole('button', { name: 'Classroom QR' })
    ...
    expect(await screen.findByRole('tooltip')).toHaveTextContent('Classroom QR')
    ...
    expect(within(daily).getByRole('button', { name: 'Classroom QR' })).toBeEnabled()
  ...
  it('switches Daily to passive manual attendance without QR check-in evidence', async () => {
    ...
    expect(within(daily).queryByRole('button', { name: 'Classroom QR' })).not.toBeInTheDocument()
