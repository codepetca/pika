...
export const HOME_CLASSROOM_EXAMPLES: HomeClassroomExample[] = [
  { id: 'science', title: 'Grade 10 Science', term: 'Semester 1', dates: 'Sep 1, 2026 – Jan 29, 2027', detail: '28 students', themeColor: 'blue', relationship: 'teaching', archived: false },
  { id: 'biology', title: 'Grade 11 Biology', term: 'Semester 1', dates: 'Sep 1, 2026 – Jan 29, 2027', detail: '24 students', themeColor: 'green', relationship: 'teaching', archived: false },
  { id: 'chemistry', title: 'Grade 12 Chemistry', term: 'Full year', dates: 'Sep 1, 2026 – Jun 25, 2027', detail: '26 students', themeColor: 'amber', relationship: 'teaching', archived: false },
  { id: 'learning-design', title: 'Learning Design', term: 'Fall 2026', dates: 'Sep 8 – Dec 15, 2026', detail: 'Alex Morgan', themeColor: 'violet', relationship: 'joined', archived: false },
  { id: 'earth-space', title: 'Earth and Space Science', term: 'Semester 2', dates: 'Feb 2 – Jun 26, 2026', detail: '25 students', themeColor: 'cyan', relationship: 'teaching', archived: true },
]

export const JOIN_EXAMPLE: HomeClassroomExample = {
  id: 'creative-computing', title: 'Creative Computing', term: 'Fall 2026',
  dates: 'Sep 8 – Dec 15, 2026', detail: 'Jamie Lee', themeColor: 'teal',
