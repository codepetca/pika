...
} from './gradebook-category-editor-state'
        ...
        <div className="flex items-center">
          ...
          >
            <Input
              ...
              disabled={category.percentageLocked}
...
export function GradebookCategoryEditorMockup({
  isOpen,
  categories,
  onClose,
  onSave,
  ...
  const percentageInputsAreValid = editor.drafts.every((category) => {
    ...
    return rawValue.trim() !== ''
      ...
      && value >= 0
      && value <= 100
      && isGradebookPercentageIncrement(value)
