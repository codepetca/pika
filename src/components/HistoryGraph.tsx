      ...
      <div className={`relative overflow-hidden ${showHeading ? 'mt-1' : ''}`}>
        ...
        {showContextLabel && (
          <div
            ...
            className="pointer-events-none absolute left-1/2 top-1 z-floating -translate-x-1/2 whitespace-nowrap rounded-control border border-border-strong bg-surface px-2 py-1 text-xs font-medium leading-tight text-text-default shadow-elevated"
          >
            {contextLabel}
          </div>
        )}
