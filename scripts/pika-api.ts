...
/**
 * How the user invoked the CLI, so suggested commands are copy-pasteable. The
 * global launcher exports PIKA_ORIGIN_PWD before handing off; the package
 * script does not.
 */
export function cliName(): 'pika' | 'pnpm pika' {
