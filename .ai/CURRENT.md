...
- Classroom archives: migrations 082-086 cover export, restore, compaction, Gradex, and cleanup. Teacher Archived lists cold tombstones with gated idempotent restore. Compaction stays server-only; cleanup is an unscheduled manual canary. Local CI runs recovery; production canaries remain.
