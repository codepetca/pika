...
- Classroom archives: migrations 082-084 provide gated export/restore and service-only Gradex ledgers. The verified coordinator has no caller; deletion, compaction, UI, and production canaries remain unfinished.
