...
- Migrations 001-105 locally verified; 105 is not hosted. Archive v2 compatibility is implemented; the next retirement pass is the atomic Quiz freeze/backfill ledger. Archive canary is verified; source/Gradex cleanup remains disabled.
