...
- Classroom archives: migrations 082-084 provide gated export/restore and Gradex ledgers. Gradex generation and the unscheduled manual cleanup trigger are disabled; compaction, UI, and production canaries remain unfinished.
