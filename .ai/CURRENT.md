...
- Classroom archives: migrations 082/083 provide gated export/restore; stacked migration 084 adds service-only Gradex operation/cleanup ledgers. The pure transformer exists, but runtime upload/deletion, compaction, UI, and production canaries remain unfinished.
