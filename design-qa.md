...
- States: open default, closed session, QR correction with Undo, one checked student with the selected-student menu open, internally scrolled/sorted roster, Attendance hours dialog, and no-session-time fallback
